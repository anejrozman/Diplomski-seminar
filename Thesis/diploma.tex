    ...
    \subsection{Lahkorepe porazdelitve}
        ...
        \subsubsection{Lundbergova neenakost}
            ...
            \begin{proof}
                ...
                torej je $I$ interval, poltrak ali kar cela realna os. Po predpostavki obstaja $\ell \in I$ za 
        ...
        \subsubsection{Asimptotika verjetnosti propada}
            ...
            \begin{proof} 
                ...
                "Ce pa je $u\mapsto qe^{\ell u}(1 - \overline{F}_X(u))$ direktno Riemannovo integrabilna
                ...
                \end{align*}
                Tako vidimo, da je $qe^{\ell u}(1 - \overline{F}_{X_1}(u))$ razlika dveh nenara"s"cajo"cih
