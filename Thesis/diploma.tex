...
%        \end{definicija}
    ...
    \subsection{Markiranje sestavljenega Poissonovega procesa}
        ...
        \begin{izrek}(o markiranju CPP)
            ...
            $[0, \infty) \times \R$. Potem so za vsak fiksen $t\geq0$ in $j = 1, \dots, n$ slu"cajne spremenljivke
            \begin{equation}
        ...
        \begin{proof}
            ...
            \begin{align*}
                \log\varphi_{S_t^{(1)},\dots, S_t^{(n)}}(u_1, \dots, \ u_n) 
                    ...
                    &= 
            \end{align*}
            Vidimo, da je (reference) vsota logaritmov karakteristi"cnih funkcij $\varphi_{S_t^{(j)}}$. 
        ...
        alternativen dokaz za dokaz neodvisnosti in stacionarnosti prirastkov CPP.
        ...
        \begin{proof}
            ...
            \begin{equation*}
                A_j = [t_{j-1}, t_j)\times \R, \quad j = 1, \dots, n.
            \end{equation*}
            Potem so slu"cajne spremenljivke $S_{t_1}^{(1)}, \dots, \ S_{t_n}^{(n)}$ neodvisne in enako
            porazdeljene kot 
            \begin{equation*}
