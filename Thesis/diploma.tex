...
%
    ...
    \subsection{Lahkorepe porazdelitve}
        ...
        \subsubsection{Cramérjeva meja za propad}
            ...
            \begin{opomba}
                Izrek \ref{izr:CramerjevaMeja} nam pove, da v primeru lahkorepih porazdelitev verjentost
                propada asimptoti"cno to"cno ekspoenento pada proti 0.
            ...
            \end{zgled}
                ...
                Poka"zimo kako v primeru, ko ne moremo priti do eksplicitne formule,
                 do pribli"zkov funkcije $\psi(u)$ lahko pridemo z Monte Carlo simulacijami.
...
\section{Priloga}
    ...
    za namene preglednosti besdila. V primeru, da bralec potrebuje osve"ziti dolo"cene pojme, 
