...
{\bf Klju"cne besede:} slu"cajni procesi, sestavljeni Poissonov proces, Cramér-Lundbergov model\\[1mm]
...
\begin{figure}[H]
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \draw[->, blue] (2.8, 1.2) .. controls (3.1, 1.7) and (3.6, 2) .. (5, 2.3);
            \filldraw[blue] (5, 2.5) circle (0.7pt);
            \draw[blue] (5, 2.5) .. controls (6, 2.8) and (7.5, 3) .. (9, 3.15) node[below] {$F(x)$};

            % CDF of F_n, 
            \draw[->, red] (-0.75, 0.2) -- (0.25, 0.2);
            \filldraw[red] (-0.75, 0.2) circle (0.7pt);
            \draw[->, red] (0.25, 0.3) -- (1.25, 0.3);
            \filldraw[red] (0.25, 0.3) circle (0.7pt);
            \draw[->, red] (1.25, 0.5) -- (2.25, 0.5);
            \filldraw[red] (1.25, 0.5) circle (0.7pt);
            \draw[->, red] (2.25, 0.5) -- (3.25, 0.5);
            \filldraw[red] (2.25, 0.5) circle (0.7pt);
            \draw[->, red] (3.25, 0.2) -- (4.25, 0.2) node[above left]{$F_n(x)$};
            \filldraw[red] (3.25, 0.2) circle (0.7pt);
            \draw[->, red] (4.25, 0.5) -- (5.25, 0.5);
            \filldraw[red] (4.25, 0.5) circle (0.7pt);
            \draw[->, red] (5.25, 0.2) -- (6.25, 0.2);
            \filldraw[red] (5.25, 0.2) circle (0.7pt);
            \draw[->, red] (6.25, 0.5) -- (7.25, 0.5);
            \filldraw[red] (6.25, 0.5) circle (0.7pt);
            \draw[->, red] (7.25, 0.2) -- (8.25, 0.2);
            \filldraw[red] (7.25, 0.2) circle (0.7pt);
...
\end{figure}
    ...
    porazdelitveno funkcijo $F(x)$. Seveda velja $F_n \xrightarrow{n\to\infty}F$ povsod kjer je $F$ zvezna.
