...
\section{Cramér-Lundbergov model}
    ...
    zavarovalnice za propad. Čeprav naj bi bil model obravnavan kot stiliziran opis resničnosti, 
    lepo zajema bistvo dinamike ravni presežka zavarovalne družbe, kar pojasnjuje, zakaj je postal 
    neizpodbiten merilni model v teoriji propada.
    ...
    \subsection{Proces tveganja in verjetnost propada}
        ...
        modelu ponuja realističen približek, saj kljub morebitni netočnosti v resničnih podatkih 
        dobro odraža splošni trend rasti. To je zato, ker zavarovalnice pogosto doživljajo 
    ...
    \subsection{Lahkorepe porazdelitve}
        ...
        \subsubsection{Cramérjeva meja za propad}
            ...
            \begin{lema}
                ...
                Potem $\delta(u)$ zado"sca nasljednji enakosti
                \begin{equation*}
                    \delta(u) = \delta(0) + \frac{1}{(1+\rho)\E\left[X\right]} \int_{(0, u]}\biggl((1 - F_X(x))\delta(u - x)\biggr)dx.
                \end{equation*}
            \end{lema}
