    ...
    \subsection{Lahkorepe porazdelitve}
        ...
        \end{zgled}
            ...
            \begin{zgled}
                ...
                \noindent
                Kot vidimo, se pribli"zki z nara"s"cajocim "stevilom simulacij pribli"zujejo funkciji $\psi(u)$, ampak, za 
...
%
    ...
    \begin{proof}
        \textcolor{red}{
        Ozna"cimo s $F_{X_1, \dots, X_n}$ skupno porazdelitveno funkcijo slu"cajnih spremenljivk
        $X_1, \dots, X_n$. Ker so slu"cajne spremenljivke $X_1, \dots, X_n$ izmenljive, za poljubno permutacijo
        $\pi$ velja $F_{X_1, \dots, X_n} = F_{X_{\pi(1)}, \dots, X_{\pi(n)}}$.
        ...
        }
    \end{proof}
