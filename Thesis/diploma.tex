...
%        \end{definicija}
    ...
    \subsection{Markiranje}
        ...
        \begin{proof}
            ...
            Torej 
            \begin{align*}
                &\E\left[\exp\left[\sum_{j = 1}^niu_jX_1\mathbbm{1}_{A_j}\left(U_1, X_1\right)\right] - 1 \right] \\
                &= \sum_{j=1}^n\E\left[\exp\left[iu_jX_1 - 1\right]\mathbbm{1}_{A_j}\left(U_1, X_1\right)\right] \\
                &= \sum_{j=1}^n\E\left[\exp\left[iu_jX_1\mathbbm{1}_{A_j}\left(U_1, X_1\right) - 1\right]\right]
            \end{align*}
        ...
        alternativen dokaz za neodvisnost prirastkov.\footnote{V delu 
