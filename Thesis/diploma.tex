...
\section{Sestavljeni Poissonov proces}
    ...
    \subsection{Osnovne lastnosti}
        ...
        \noindent
        Po standardni formuli za varianco $\Var{S_t} = \E\left[S_t^2\right] - \E\left[S_t\right]^2$ 
        potrebujemo izra"cunati le "se drugi moment. Ponovno uporabimo formulo za popolno pri"cakovano vrednost.
    ...
    Iz definicije $HPP$ vemo, da je $N_t$ za $t\geq0$ porazdeljena kot Poissonova slu"cajna 
    ...
    posebne primere, je zgornji izraz za prakti"cne namene ne-izra"cunljiv in nam v praksi ne pomaga veliko.
    ...
    \begin{zgled}
        ...
        \end{equation*}
        s parametrom $a>0$, lahko deloma eksplicitno zapi"semo porazdelitev $CPP$. Gostota $k$-te 
