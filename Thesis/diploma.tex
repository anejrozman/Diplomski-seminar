...
funkcij, obravnavamo njeno povezavo s splo"snimi porazdelitvami in izpeljemo Panjerejevo rekurzivno shemo. 
...
sestavljeni Poissonov proces markiramo in ga 
obravnavamo kot gradnik neskon"cno deljivih procesov ti. Lévijevih procesov. 
...
compound Poisson process, space-time decomposition, infinite divisibility,
...
V nastajanju :) 
%\noindent
%Zahvaljujem se doc.\ dr.\ Martinu Rai"cu za njegovo mentorstvo. S svojim znanjem in izkušnjami 
%mi je pomagal ne le pri razumevanju snovi predstavljene v delu, ampak tudi pri razlagi
%naprednej"sih tem, ki so povezane s slu"cajnimi procesi. Hvaležen sem mu za njegovo izjemno pripravljenost,
%večkratne (dolge) diskusije, svetovanje pri dokazovanju izrekov, oblikovanju in natančnost pri 
%pregledovanju besedila.
%
%\noindent
...
ki jo izpeljemo. Na nekatere klju"cne definicije in rezultate, ki jih bomo uporabljali bodo posebej 
ozna"cene kot (\refPriloga{def:rodovneFunkcije}). Bralec jih nato lahko najde v prilogi. 
...
\section{Sestavljena Poissonova porazdelitev}
    ...
    lastnosti slu"cajnih spremenljivk so rodovne funckije (\refPriloga{def:rodovneFunkcije}), saj nam pomagajo
...
%        \end{definicija}
    ...
    \subsection{Neskon"cna deljivost}
        ...
        deljivimi porazdelitvami karakteriziramo enega najsplo"snej"sih 
    ...
    Sedaj navedemo nekaj klju"cncih rezultatov, ki ilustrirajo pomembnost sestavljene Poissonove porazdelitve in 
    sestavljenega Poissonovega procesa v bolj splo"sni teoriji slu"cajnih procesov. Dokazi trditev in izrekov presegajo delo in bralec jih lahko najde v knjigi 
    \cite{10} ki je izklju"cno namenjena teoriji neskon"cno deljivih porazdelitev. 
    ...
    \begin{proof}
        Dokaz lahko bralec najde v \cite{7} na strani ....
    \end{proof}

    Do sedaj smo ve"ckrat omenili Lévijeve procese. Definiramo jih na slede"c na"cin. 
    ...
    \begin{proof}
        Dokaz izreka lahko bralec najde v \cite{10} na strani 35.
    \end{proof}  
    ...
    imajo $X_i$ porazdelitev $\frac{\nu(\{B\})}{\lambda}$, kjer je $B$ poljubna Borelova mno"zica.
...
\section{Cramér--Lundbergov model}
    ...
    \subsection{Proces tveganja in verjetnost propada}
        ...
        \begin{opomba}
            ...
            ampak lahko privzamemo, da sledijo splo"snemu prenovitvenemu procesu (\refPriloga{def:PrenovitveniProces}). 
        ...
        \begin{proof}
            ...
            velikih "stevil (\refPriloga{izr:KrepkiZakonVelikihStevil}), torej velja
            \begin{equation*}
    ...
    \subsection{Lahkorepe porazdelitve}
        ...
        \subsubsection{Asimptotika verjetnosti propada}
            ...
            \begin{proof} 
                ...
                \end{equation}
                Vidimo, da ima ena"cba (\refPriloga{eq:verjetnostPropadaQ}) obliko prenovitvene 
            ...
            \begin{zgled}
                ...
                \noindent
                Kot vidimo, se pribli"zki z nara"s"cajocim "stevilom simulacij pribli"zujejo funckciji $\psi(u)$, ampak, za 
