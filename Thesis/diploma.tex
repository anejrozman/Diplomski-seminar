...
\section{Sestavljeni Poissonov proces}
    ...
    osnovne definicije in lastnosti med definicijama (\ref{def:slucProc}) in 
    (\ref{def:neodvisnostSP}) v Prilogi.
    ...
    Ker je sestavljeni Poissonov proces nadgradnja homogenenga Poissonovega procesa, najprej podamo definicijo 
    ...
    $T_1 \sim \text{Exp}(\lambda)$. Ta lastnost je tudi alternativna definicija procesa. Bralec 
    ...
    (angl. Compound Poisson Process), kjer privzamemo, da prihodi sledijo nekem $\HPP(\lambda)$. 
...
%
        ...
        \begin{trditev}
            ...
            neodvisne in stacionarne prirastke natanko tedaj, ko je za poljubna realna "stevila
        ...
        \begin{proof}
            ...
            Po trditvi (\ref{trd:CPDneskoncnoDeljiva}) vemo, da je ta enaka porazdelitvi slu"cajne spremenljivke
            $X_{t_{n+1}} - X_{t_n}\mid g(X_0, X_{t_1}, \dots, X_{t_n})$ za poljubno merljivo funkcijo $g:\R^{n+1}\to \R^{n+1}$,
            ...
            Po neodvisnosti in stacionarnosti prirastkov $(X_t)_{t\geq0}$ sledi (\ref{eq:neodvisnostStacionarnostPrirastov}).
...
%        \end{definicija}
    ...
    \subsection{Markiranje sestavljenega Poissonovega procesa}
        ...
        porazdeljenih slu"cajnih spremenljivk izrazili s skupno sestavljeno Poissonovo porazdelitvijo. S particijo "casa in 
    ...
    Naslednji rezultat je precej bolj zahteven in presenetljiv.
