...
\section{Sestavljena Poissonova porazdelitev}
    ...
    \begin{opomba}
    Kaj pa v primeru, ko $X_i$ nimajo diskretne porazdelitve? 
    Izkra"ze se, da tudi v splo"snem dobimo konvergenco v porazdelitvi. 
    Ideja je, da definiramo $F_n(x) := F(\tfrac{m}{n})$ kjer je
    $F(x)$ porazdelitvena funkcija slu"cajne spremenljivke $Z_n$ in 
    $m = \min\{k \in \mathbb{Z} \mid F(\tfrac{k}{n}) > F_n(x)\}$.
