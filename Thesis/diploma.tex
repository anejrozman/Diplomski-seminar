...
%\Author{Anej Rozman}
%\Language{si-SLO}
%\Subject{V prvem delu diplome najprej definiramo sestavljeno Poissonovo porazdelitev in izpeljemo obliko njenih rodovnih 
...
%\Keywords{slu"cajni proces,\sep sestavljena Poissonova porazdelitev,\sep Panjerjeva rekurzivna shema,\sep 
%sestavljeni Poissonov proces,\sep markiranje,\sep
% Cramér--Lundbergov model,\sep Verjetnost propada,\sep lahkorepa porazdelitev,\sep te"zkorepa porazdelitev}
%\end{filecontents*}
...
% Kar je zakomentirano zgoraj so paketi za ustvariti pdf-a datoteko
%--------------------------------------OBLIKA DOKUMENTA--------------------------------------------%
